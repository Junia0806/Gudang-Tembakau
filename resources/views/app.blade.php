...
<body >
  ...
  <div class="bg-center bg-no-repeat bg-cover bg-landing flex items-center justify-center min-h-screen">
    <div class="bg-white bg-opacity-50 p-6 rounded-lg shadow-lg">
      <h1 class="text-2xl font-bold mb-4 text-center">Login ke Hatinya Mas Rico</h1>
